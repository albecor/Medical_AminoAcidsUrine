...
<nav class="navbar navbar-toggleable navbar-inverse bg-primary">
 ...
 <i class="fa fa-file-text " aria-hidden="true"></i>   </a>
				<div class="dropdown-menu">
					<a class="dropdown-item"  target="_blank" href="https://drive.google.com/file/d/0By1VjmcVY702N1o5ck81bER5RlU/view?usp=sharing"> <i class="fa fa-cloud-download fw" aria-hidden="true"></i> <spring:message code="user-manual" /> </a> 
				</div></li>
